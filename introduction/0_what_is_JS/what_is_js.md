...
Очень часто, бывают ситуации, когда нужно выполнить ту или иную логику, в зависимости от каких-либо значений в конкретных переменных.
...
Мы создали функцию `toTakeTheWheel` (сесть за руль), которая будет выполнять необходимые действия для того, чтобы сесть за руль.
...
Когда значение переменной будет `true`, выполняется первый блок кода, в котором находится запуск функции `toTakeTheWheel`,
...
3. Написать скрипт, для проверки прав доступа пользователя. Права доступа могут быть: “Admin”, “Editor”, “Viewer”, “Owner”, null
   - Если права доступа пользователя - Admin, то выводить сообщение в консоль: “Здравствуйте, Администратор!”/
   - Если права доступа - Editor, то “Здравствуйте, Редактор! Ваши права ограниченны. Вам доступно чтение и редактирование статей.”
   - Если права доступа Viewer - “Здравствуйте! Для вас доступен только просмотр содержимого статей”
   - Если права доступа Owner - “Здравствуйте. Вы можете назначать роли для других пользователей сервиса, управлять данными”
