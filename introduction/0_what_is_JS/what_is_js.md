...
- Значения переменных в JS, могут иметь 1 из 8 типов данных: `string`, `number`, `boolean`, `null`, `undefined`, `symbol`, `bigint`, `object`.
...
- Существует конструкция, позволяющая выполнять код только в случае, если выполнено определенное условие: `if/else/else if`.

## <a id="trains">Тренировка</a>

[//]: # (TODO дописать задания для тренировки...) 
