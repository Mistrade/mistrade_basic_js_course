...
Важная особенность JavaScript - при сравнении разных типов данных в одном выражении, будет произведение приведение этих
значений к числу.
...
> 
> Буквально недавно, была ситуация, когда кандидат на позицию `middle` провалил интервью, не ответив на вопрос о работе данного оператора.
...
> Поскольку данный оператор был добавлен в язык относительно недавно, то могут возникнуть проблемы при работе с ним, поскольку старые браузеры не умеют работать с ним.
> 
