...
- Реузльтат сравнения возвращает `boolean` значение.
...
- Оператор [строго сравнения](#strict_compare) сравнивает и тип данных, и значение. Если одна из проверок вернет `false`, результат
